      ...
      <div className="container mx-auto py-16 px-4">
        ...
        <div className="flex flex-col items-center justify-center mb-12">
          <h1 className="text-4xl font-bold mb-4 text-center">
            <span className="text-primary">BMI</span> Interiors Company Profile
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          <div className="lg:col-span-2">
            <div className="prose prose-invert max-w-none">
              <h2 className="text-2xl font-bold mb-4">About BMI Interiors</h2>
              <p>
                BMI Interiors is a premier interior design firm based in Dubai, specializing in creating exceptional
              ...
              <p>
                At BMI Interiors, we follow a structured approach to ensure that every project is completed to the
