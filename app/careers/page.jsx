        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Build your career with BMI Interiors and be part of a team that's transforming spaces and creating
            ...
            <TabsContent value="benefits" className="animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                <div>
                  ...
                  <p className="text-gray-300 mb-6">
                    At BMI Interiors, we believe that our team is our greatest asset. We're committed to creating a
                  ...
                  {[
                    {
                      ...
                      description:
                        "Submit your application through our online portal. Include your resume, portfolio (if applicable), and a cover letter explaining why you're interested in joining BMI Interiors.",
                    },
                    {
                      step: "02",
